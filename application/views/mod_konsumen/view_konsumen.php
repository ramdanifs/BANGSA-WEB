            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Jumlah Pengguna</h3>&ensp;:&ensp;
                    <?php $jmlb = $this->model_app->view('rb_konsumen')->num_rows(); ?>
                    <span class="info-box-number" style="margin-left: 155px; margin-top: -22px;"><?php echo $jmlb; ?></span>
                  <!-- <a class='pull-right btn btn-primary btn-sm' href='<?php echo base_url(); ?>main/tambah_konsumen'>Tambahkan Data</a> -->
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                <a class='btn btn-warning btn-xs' title='Edit Data' href='".base_url()."main/edit_konsumen/$row[id_konsumen]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."main/delete_konsumen/$row[id_konsumen]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>
                          </tr>";
                      $no++;
                    }
